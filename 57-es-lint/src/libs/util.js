...
export const setTagNavListInLocalstorage = list => {
    localStorage.tagNaveListDangan = JSON.stringify(list)
}
/**
 * @returns {Array} 其中的每个元素只包含路由原信息中的name, path, meta三项
 */
export const getTagNavListFromLocalstorage = () => {
    const list = localStorage.tagNaveListDangan
...
export const getTextByCodeFromDict = (dictData, dicName, code) => {
    let ret = dictData[dicName].find(v => {
        return v.code === code;
    });
    return ret && ret.description
}
